      ...
      <div className='main-screen'>
        <nav className="menu-nav">
          ...
          <div className='menu-nav-pages'>
            ...
            <div className='menu-nav-item selected'>
              👋
              Swipe & Fly
            </div>
          </div>
